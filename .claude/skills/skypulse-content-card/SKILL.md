---
name: skypulse-content-card
description: Generar o ajustar tarjetas de contenido de fenómenos para SkyPulse — piezas tipo tarjeta (prompt de imagen + descripción breve + significado + acción) para las secciones Nubes y Desastres de la app. Usar cuando se pida redactar, generar, reescribir o ajustar copy/contenido de un fenómeno del catálogo (cumulonimbos, cirros, terremotos, huracanes, tsunamis, etc.). NO usar para trabajo de ingeniería sobre el código de apps/frontend o apps/backend — eso lo gobierna CLAUDE.md directamente.
---

# SkyPulse — Generación de Tarjetas de Contenido (Image-first)
...
- **Reutilizar siempre antes de crear**:  
  - Debe buscar primero en `README.md`, este skill y el catálogo de fenómenos.  
...
Este skill define el comportamiento completo del agente para generar contenido consistente.
