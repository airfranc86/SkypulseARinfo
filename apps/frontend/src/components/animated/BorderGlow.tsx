...
interface BorderGlowProps {
  ...
  className?: string
  style?: CSSProperties
  /** Edge proximity threshold for glow activation (0–100) */
  edgeSensitivity?: number
  /** Glow color in "H S L" format, e.g. "142 64 58" for green */
  glowColor?: string
  ...
  coneSpread?: number
  /** Play sweep animation on mount */
  animated?: boolean
  /** Gradient overlay colors (array of 2–3 hex colors) */
  colors?: string[]
  fillOpacity?: number
}

/**
 * BorderGlow — React Bits port (TypeScript).
 * Cursor-tracked edge glow with multi-color gradient border.
 * Use `animated={true}` for a persistent sweep on mount.
 */
